...
if (validateAttachment({ name: 'notes.txt', size: 1024, type: 'text/plain' })) throw new Error('Valid TXT was rejected')
...
console.log('Ticket attachment validation passed: allowed PNG/TXT, blocked executable, blocked oversized file.')
